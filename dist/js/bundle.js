...
const tabs = (tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) => {
  ...
  function showTabContent(i = 0) {
    ...
    tabs[i].classList.add(tabsSelector.slice(1));
  }
...
window.addEventListener('DOMContentLoaded', function () {
	...
	;(0,_modules_timer__WEBPACK_IMPORTED_MODULE_1__["default"])('.timer', `${new Date().getFullYear() + 1}-05-20`)
	;(0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__["default"])('[data-modal]', '.modal', timerId)
	;(0,_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])('form', timerId)
